...
function Evidencia() {
    return (
        <div id="evidencia" className="container my-5 p-5">

        <h2  className="title is-ancestor has-text-centered ">
            Evidencia de cuidar el medioambiente en la escuela 14 de diciembre.
        </h2>
                ...
                <div className="card">
                    ...
                    <div className="card-content">
                        ...
                        <div className="content">
                            ...
                            <a href="#">#responsive</a>
                            <br />
                            <time dateTime="2016-1-1"><i class="fas fa-clock"></i> 11:09 PM - 1 Jan 2016</time>
                        </div>
                    </div>
                </div>
